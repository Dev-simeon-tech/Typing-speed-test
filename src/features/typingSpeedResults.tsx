...
const TypingSpeedResults = () => {
  ...
  return (
    <div className='mt-8 pb-15 pt-10 md:mt-20 lg:mt-16 overflow-x-hidden relative'>
      {isBaseline && (
      ...
      {isBaseline ||
        (!isHighScore && (
          <>
            <Star_1 className='fixed bottom-0 md:bottom-1/5 w-9.5 md:w-auto right-5' />
            <Star_2 className='fixed md:top-35 md:left-15 top-25 w-5.5 md:w-auto left-5' />
          </>
        ))}
      {isHighScore && (
        <div className='fixed left-0 bottom-0 w-full  md:h-[28vh] -z-10 flex justify-center items-center'>
          {/* <ConfettiPattern className='h-full w-full ' /> */}
